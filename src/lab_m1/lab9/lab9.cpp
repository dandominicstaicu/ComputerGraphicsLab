...
void Lab9::Init()
{
    ...
    // Create a simple quad
    {
        ...
        vector<glm::vec2> textureCoords
        {
            ...
            glm::vec2(0.0f, 0.0f)  // top leftCreateRandomTexture
...
void Lab9::Update(float deltaTimeSeconds)
{
...

    {
        ...
        modelMatrix = glm::scale(modelMatrix, glm::vec3(0.1f));
        RenderSimpleMesh(meshes["quad"], shaders["LabShader"], modelMatrix, mapTextures["bamboo"], mapTextures["grass"]);
    }
}
...
void Lab9::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, Texture2D* texture1, Texture2D* texture2)
{
    ...
    if (texture1 && texture2) {
        glUniform1i(glGetUniformLocation(shader->program, "mode"), 2);
    } else {
        glUniform1i(glGetUniformLocation(shader->program, "mode"), 0);
    }
